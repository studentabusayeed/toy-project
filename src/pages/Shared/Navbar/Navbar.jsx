...
const Navbar = () => {
    ...
    const Menu = <>
        ...
        {user?.email ? <>
            ...
            <li><button className='font-semibold bg-blue-600 px-5 py-1 rounded-lg flex items-center text-white mx-2 log-btn' onClick={handleLogout}>Log out</button></li>
        </> :
            <Link className='font-semibold bg-blue-600 px-5 py-1 rounded-lg flex items-center text-white mx-2 log-btn' to="/login">Login</Link>}
        <Link className='font-semibold bg-blue-600 px-5 py-1 rounded-lg flex items-center text-white reg-btn mx-2' to="/register">Register</Link>
    </>
